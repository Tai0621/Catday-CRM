...
export const SEGMENTS: NavSegment[] = [
  ...
  },
  {
    ...
    groups: [{ links: [
      ...
      { href: '/hr/applications', label: 'Applications', icon: 'application' },
      { href: '/hr/roles', label: 'Roles & Access', icon: 'shield' },
  ...
  },
  {
    ...
    groups: [{ links: [
      ...
      { href: '/marketing/content', label: 'Content Studio', icon: 'pen' },
  ...
  },
  {
    ...
    groups: [
      ...
      { sub: 'Configuration', subColor: '#B8902B', links: [
        ...
        { href: '/admin/branding', label: 'Brand Colours', icon: 'palette' },
