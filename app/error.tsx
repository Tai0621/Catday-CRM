    ...
    <div className="flex items-center justify-center" style={{ minHeight: '70vh' }}>
      <div className="cd-card p-8 text-center max-w-md space-y-3">
        ...
        <p className="text-sm cd-muted">
          ...
          your work is most likely saved. Try again, or refresh the page.
        </p>
        <div className="flex items-center justify-center gap-2 pt-1">
          <button onClick={() => reset()} className="cd-btn text-sm">Try again</button>
          <button onClick={() => window.location.reload()} className="cd-btn-sec text-sm">Refresh page</button>
        </div>
      </div>
    </div>
  )
