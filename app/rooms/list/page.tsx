    ...
    <div className="max-w-5xl mx-auto space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <h1 className="text-xl font-bold" style={{ color: '#2D1907' }}>Rooms — list</h1>
          {/* Kept alongside the wall on purpose: it is faster to search, it is
              what a screen reader reads, and it is the fallback when the wall
              looks wrong. */}
          <p className="text-sm cd-muted">Every room, searchable — the wall&rsquo;s plain-text twin.</p>
        </div>
